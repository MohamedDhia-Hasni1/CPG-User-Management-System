        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <button 
  class="bg-red-600 hover:bg-red-700 text-white font-medium text-base px-4 py-2 rounded-xl shadow flex items-center gap-2"
  (click)="logout()"
>
...
function removeCookie(name: string, options: { path: string }) {
  document.cookie = `${name}=; Path=${options.path}; Expires=Thu, 01 Jan 1970 00:00:00 GMT; SameSite=Lax`;
}